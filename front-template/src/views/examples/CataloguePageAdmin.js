...
import AnnonceAdmin from '../../components/AnnonceAdmin';
                      ...
                      <tbody>
                    
                        {
                            this.state.annonces.length !== 0 ?
                                this.state.annonces.map((item, index) => {
                                    return (
                                        <AnnonceAdmin key={index} data={item} detailsAnnonce={(id) => this.detailsAnnonce(item._id)} deleteAnnonce={() => this.deleteAnnonce(item._id)}/>
                                    )
                                })
